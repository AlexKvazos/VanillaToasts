...
Create toasts & notifications on your website with ease. This library is immensely lightweight and depends on no other library. Simply load the script and css to your page, and use the simple API to start launching toasts on your page.
