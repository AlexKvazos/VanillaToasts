...
Create toasts & notifications on your website with ease. This library is independent and extremely lightweight . Simply load the script and css to your page, and use the simple API to start launching toasts on your page.
