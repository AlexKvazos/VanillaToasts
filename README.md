...
Create toasts & notifications on your website with ease. This library is extremely lightweighted and independent of other libraries. Simply load the script and css to your page, and use a simple API to start launching toasts on your page.
